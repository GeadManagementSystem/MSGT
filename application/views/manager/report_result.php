              ...
              <div id="page-wrapper">
                  ...
                  <div class="row">
                    <div class="panel panel-default col-lg-12">
                      <div class='panel-heading col-lg-12'><h4 class='text-muted'>Generated Report</h4></div>
                                  ...
                                  <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_price;?></div>
                                            <div>Amount Collected in this period</div>
                                        </div>
                                    </div>
                                  </div>
                              </div>
                              ...
                              <div class="panel panel-success">
                                  <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo $total_quantity;?></div>
                                            <div>Item sold in this period</div>
                                        </div>
                                    </div>
                                  </div>
                              </div>
                      ...
                      <div class="panel-footer "><span class="col-lg-6 text-muted">From: <?php echo $from_date;?>     To: <?php echo $to_date;?></span>
                        <span class="col-lg-2" ></span>
                        <button class='btn btn-info btn-sm col-lg-4' onclick="window.print()">
